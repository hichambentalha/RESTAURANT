...
public class RestaurantTest {
	 ...
	 * 
	 * if there is not quantity it means that the ingredient is in stock and
	 * unlimited. (here it concern olive oil and pepper)
	 * 
	 */
	...
	public void shouldFailWhenOutOfStock() {
		...
		Restaurant restaurant = new Restaurant("6 balls Mozzarella", "20 tomatoes", "olive oil", "pepper");
		Ticket ticket = restaurant.order("6 Tomato Mozzarella Salad");
		Meal meal = restaurant.retrieve(ticket);
	}
	 ...
	 * 
	 * first dish takes standard time, subsequents dish have their cooking time
	 * halved
	 *
	 * 
	 ...
	 * 
	 * multiple dishes can be baked at the same time (providing that the temperature
	 * is in a +/- 30 degree range ; otherwise it has to be sequential)
	 * 
	 * dishes that requires baking are always started first, as preparation of dish
	 * that doesn't require baking can be done during baking time.
	 * 
	 */
	 ...
	 * 
	 * preparation time of subsequent order after first will be impacted by first
	...
	public void shouldServeMultipleOrders() {
		...
		Restaurant restaurant = new Restaurant("1Kg Flour", "50 tomatoes", "sea salt", "6 balls Mozzarella",
				"olive oil", "water", "3 sheet of lasagna pasta", "750g lean beef mince");
		...
		// assertThat(meal2.cookingDuration()).isEqualTo("62");
